...
This server pack has [Accelerator](https://forums.alliedmods.net/showthread.php?t=277703) bundled, so we can handle
 server crashes with the crash reports instead of just seeing the process termination, to configure it, see their
 instruction in the linked page.
 
However, you should copy Accelerator config file to custom file folder to prevent
 it from being overwritten, see [Custom files](#custom-files) section to know how to place the file.

## Included Mods

| Mod                                       | Version                              | Description                                                                                                                                                                                | Source                                                                                                       |
| ----------------------------------------- | ------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------ |
| SourceMod                                 | 1.12.0-git7221 | SourceMod is server modification for any game that runs on the Half-Life 2 engine. It is a powerful, highly optimized platform for scripting plugins and handling server administration.   | https://www.sourcemod.net/                                                                                   |
| MetaMod:Source                            | 2.0.0-git1380 | Metamod:Source is a C++ plugin environment for Half-Life 2. It acts as a "metamod" which sits in between the Game and the Engine, and allows plugins to intercept calls that flow between. | https://www.metamodsource.net/                                                                               |
| L4DToolZ                                  | 2026.1.1                                | A source plugin to unlock the maximum player and tickrate limit on L4D2.                                                                                                                   | https://github.com/lakwsh/l4dtoolz                                                                           |
| Left4DHooks                               | 1.161                                | An all-in-one port to DHooks with many additions.                                                                                                                                          | https://forums.alliedmods.net/showthread.php?t=321696                                                        |
...
| Game Mode Config Loader (Fork)            | 1.8+fork.1                           | Executes a cfg file based on the games current settings at map load. Forked to fix difficulty change being reset.                                                                          | https://forums.alliedmods.net/showthread.php?p=834731                                                        |
...
| Left4Fix                                  | 2026.1.1                                | Extension for Left 4 Dead 2 servers with extra player slots.                                                                                                                               | https://forums.alliedmods.net/showthread.php?t=219774                                                        |
...
| Chat Exec                                 | 1.0.1                                | Executes .cfg files through chat commands                                                                                                                                                  | https://github.com/SNWCreations/ChatExec                                                                     |
| Accelerator                               | 2.6.0-git165-dcf3449 (Windows/Linux) | Crash Reporting That Doesn't Suck.                                                                                                                                                         | https://forums.alliedmods.net/showthread.php?t=277703                                                        |
## Custom files
